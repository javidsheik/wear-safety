...
exports.signup = function (req, res, next) {
 ...
 async.waterfall([
    ...
    function(token, next) {
        ...
        Mailer.sendOne('invitation', "Wear Safety - Invitation", user, function (err, responseStatus, html, text){
  ...
  async.waterfall([
    ...
    function(token, next) {
      User.findOne({ email: req.body.email.toLowerCase() }, function(err, user) {
        ...
        Mailer.sendOne('forgot-password', "Wear Safety - Password Reset", user, function (err, responseStatus, html, text){
          next(err, responseStatus);
        })
...
exports.devices_list = function( req, res, next) {
            ...
            Circle
               ...
               if(!circles[0]){
			    ...
			    return utils.message(res, 401, "Circle Not Found");
                         ...
                         if(!mids)
                             return utils.message(res, 401, "No Members Found.");
                            
                                        
                            console.log(mids);
                            
                            Member.where( {_id : {$in : mids[0] }}).exec( function (err, member) {
                            ...
                            if(member){         
                                ...
                                var ids = member.map(function(doc) { return doc.user_id; });
                                ...
                                console.log(device_ids);
                                    ...
                                    if(device_ids.length == 0)
                                        ...
                                        return utils.responses(res,200, {devices: device_ids});
                                  })	
